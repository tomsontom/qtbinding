...
* generated by Xtext
*/
package org.ufacekit.qt.idl.dsl.ui.refactoring;
 ...
 */
public class QIdlRenameStrategy extends AbstractJvmModelRenameStrategy {
	...
	public static class Provider extends DefaultRenameStrategy.Provider {
		...
		public IRenameStrategy get(EObject targetElement, IRenameElementContext renameElementContext) {
			return new QIdlRenameStrategy(targetElement, getLocationInFileProvider(), jvmModelAssociations);
		}
	}
	
	protected QIdlRenameStrategy(EObject targetElement, ILocationInFileProvider locationInFileProvider,
